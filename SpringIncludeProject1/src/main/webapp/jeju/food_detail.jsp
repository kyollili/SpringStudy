...
<body>
  <div class="row">
      <table class="table">
        <tr>
            <td><img src="${vo.poster }" style="width: 50%"></td>
        </tr>
      </table>
    </div>
    ...
    <div class="row">
      <div class="col-sm-8">
        <table class="table">
          ...
          <c:if test="${vo.menu!='no' || vo.nenu!=null}">
            <tr>
              <th width="10%">메뉴</th>
              <td width="90%">
                <ul>
                ...
                <table class="table">
	              ...
	              <td colspan="2">
	                <form method="post" action="../reply/update.do">
	                  ...
	                  &nbsp;<input type="submit" value="댓글 수정" style="float: left;height: 104px;" class="btn btn-sm btn-primary">
	                </form>
	              </td>
	            </tr>
                </table>
            ...
            <tr>
              <td>
                <form method="post" action="../reply/insert.do">
                  ...
                  &nbsp;<input type="submit" value="댓글 쓰기" style="float: left;height: 104px;" class="btn btn-sm btn-primary">
                </form>
              </td>
            </tr>
          </table>
