...
public class ReplyOrmDAO {
	...
	/*
	 * @Select(value="{CALL replyList(#{pRno,mode=IN,jdbcType=INTEGER},"
	...
	/*
	 * @Select(value="{CALL replyInsert(#{pRno,mode=IN,jdbcType=INTEGER},"
			+ "#{pType,mode=IN,jdbcType=INTEGER},"
			+ "#{pId,mode=IN,jdbcType=VARCHAR},"
			+ "#{pName,mode=IN,jdbcType=VARCHAR},"
			+ "#{pMsg,mode=IN,jdbcType=CLOB})}")
		@Options(statementType = StatementType.CALLABLE)
	 */
	...
	/*
	 * @Select(value="{CALL replyUpdate(#{pNo,mode=IN,jdbcType=INTEGER},"
			+ "#{pMsg,mode=IN,jdbcType=CLOB})}")
		@Options(statementType = StatementType.CALLABLE)
	 */
