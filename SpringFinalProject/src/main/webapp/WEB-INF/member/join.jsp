        ...
        <table class="table">
          <tr>
            ...
            <td width=80% class="inline">
              ...
              <input type=button value="아이디 중복 체크" class="btn btn-sm btn-outline-danger" v-on:click="idCheck()">
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" class="text-center">
              <input type=button value="회원가입" class="btn btn-sm btn-outline-success" v-on:click="memberJoin()">
              <input type=button value="취소" class="btn btn-sm btn-outline-warning" onclick="javascript:history.back()">
            </td>
          </tr>
        </table>
      </div>
