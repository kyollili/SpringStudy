      ...
      <table class="table">
        ...
        <tr>
          <td colspan="2" class="text-center">
            <input type=button value="글쓰기" class="btn btn-sm btn-outline-primary"v-on:click="write()">
            <input type=button value="취소" class="btn btn-sm btn-outline-info" onclick="javascript:history.back()">
          </td>
        </tr>
      </table>
    </main>
