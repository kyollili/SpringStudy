  ...
  <header id="header" class="clear"> 
    ...
    <div class="fl_right">
      ...
      <ul class="inline">
        ...
        <li><input type="button" value="로그인" class="btn btn-lg btn-outline-danger" v-on:click="login()"></li>
      </ul>
      </c:if>
      <c:if test="${sessionScope.id!=null }">
      <ul class="inline">
        <li>${sessionScope.name }님 로그인 중입니다</li>
        <li><input type="button" value="로그아웃" class="btn btn-lg btn-outline-success" v-on:click="logout()"></li>
      </ul>
      </c:if>
    </div>
