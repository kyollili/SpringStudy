...
<div class="wrapper row3 rows">
  <main class="container clear">
      ...
      <table class="table">
        <tr>
          <td class="inline">
            ...
            <input type="button" value="검색" class="btn btn-sm btn-outline-primary" v-on:click="find()">
          </td>
        </tr>
      </table>
    </div>
    ...
    <div class="row">
        ...
        <li v-if="totalpage>endPage"><span class="btn btn-xs btn-outline-default" v-on:click="next()">&gt;</span></li>
      </ul>
    </div>
  </main>
</div>
