...
public class DataBoardController {
	...
	public void databoard_download(String fn,HttpServletResponse response)
	{
		try
		{
			...
			BufferedOutputStream bos=new BufferedOutputStream(response.getOutputStream());//사용자 다운 받는 위치
			int i=0;
	...
	//update.do?no=${vo.no }
	@GetMapping("databoard/update.do") //form태그 없으면 다 getMapping!
	...
	//실제 수정
	@PostMapping("databoard/update_ok.do")//폼태그 있으니까 postMapping!
