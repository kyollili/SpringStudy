...
/*$(function(){
   //버튼 클릭 시
   $(".category_filed").click(function(){
      if(!$(this).hasClass("active")){
         $(this).addClass("active");
         $(this).next(".filter_category").slideDown();
      }
      else {
            $(this).removeClass("active");
            $(this).next(".filter_category").slideUp();
          }
   })
})
...
$(function(){
   //버튼 클릭 시
   $(".category_filed1").click(function(){
      if(!$(this).hasClass("active")){
         $(this).addClass("active");
         $(this).next(".filter_category").slideDown();
      }
...
<!--               [D] depth1 개수만큼 .sub_contents 생성 -->
        ...
        <li>
          <button type="button" class="category_filed1">클래스 진행 방식</button>
...
<!--               </form> -->
    ...
    <div class="category_path">
      <span>${vo.catename }</span> <!-- 여기 카테네임 -->
      <span>공예/DIY</span>         <!-- 여기 디테일카테네임 어떻게 들고오지..? -->
   </div>
    <!-- result_count -->
            ...
            <nav class="pagination">
              <ul class="list-inline">
                ...
                <li class="current" v-for="i in range(startPage,endPage)" v-if="i==curpage">
                  <a class="act" v-on:click="pageClick(i)">{{i}}</a> <!-- 여기 틀렸다는건데... -->
                </li>
                <li v-else>
