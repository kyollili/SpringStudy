  ...
  <div class="container-fluid">
      <div class="col-sm-4">
        <div class="text-center">
          ...
          <button class="btn btn-sm btn-success" v-on:click="change(2)">지역별 인기 맛집 리스트</button>
          <button class="btn btn-sm btn-warning" v-on:click="change(3)">메뉴별 인기 맛집 리스트</button>
        </div>
        <div style="height: 10px"></div>
          <div class="col-md-6 ddd" v-for="vo in cate_list">
	       <div class="thumbnail">
